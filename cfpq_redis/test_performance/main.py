...
from cfpq_redis.test_performance.test_suits import get_total_cases, get_suite_cases, get_suite_names, get_additional_cases
...
def main():
    ...
    parser.add_argument('test_suite_name', help='name of test suite',
                        choices=get_suite_names() + [FULL, ADDITIONAL], default='FULL')
